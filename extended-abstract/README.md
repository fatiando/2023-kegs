...
Boule is a very lightweight library that hosts classes for representing
geodetic reference ellipsoids for the Earth and for celestial bodies of the
solar system like the Moon, Mars, Venus, and Mercury.
